...
dir_save_stack=r"E:\Liu\20240226_stereo_with_sato\stereo\edge_detection\\"
os.makedirs(dir_save_stack,exist_ok=True)
dir_save_0deg=r"E:\Liu\20240226_stereo_with_sato\stereo\edge_detection\0deg\\"
os.makedirs(dir_save_0deg,exist_ok=True)
dir_save_20deg=r"E:\Liu\20240226_stereo_with_sato\stereo\edge_detection\20deg\\"
os.makedirs(dir_save_20deg,exist_ok=True)

path_0deg=r"E:\Liu\20240226_stereo_with_sato\add_results\0deg\\"
path_20deg=r"E:\Liu\20240226_stereo_with_sato\add_results\20deg\\"

#後半2枚はエッジ抽出はしない（粒界の連結部分において、どこまでを再構成の対象とする粒界なのかを決定するため）
list_file_name=["008_009.tif","006_008.tif","006_009.tif","003_009.tif","003_006.tif"]
...
#塗りつぶし
#粒界のスタック画像からエッジを抽出
contours_0deg,_=cv2.findContours(stack_0deg,1,2)
contours_20deg,_=cv2.findContours(stack_20deg,1,2)
...
cv2.imwrite(dir_save_stack+"stack_0deg.tif",black_0deg)
cv2.imwrite(dir_save_stack+"stack_20deg.tif",black_20deg)
