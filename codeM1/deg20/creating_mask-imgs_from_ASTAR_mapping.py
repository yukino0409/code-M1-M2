...
#マスク画像の出力先
dir_save=r"E:\Liu\20240405\mask_imgs\beta_20deg\\"
os.makedirs(dir_save,exist_ok=True)
#ASTARのマッピング画像(グレースケール)の保存先
dir_save_gray=r"E:\Liu\20240405\mask_imgs\beta_20deg\whole\\"
os.makedirs(dir_save_gray,exist_ok=True)

#ASTARの方位マッピング画像を読み込む
mapping=cv2.imread(r"E:\Liu\20240405\beta_20deg\map_beta_20deg_selected.tif")

#各種パラメータ設定
tilt_angle=20
max_value=255
mapping=mapping[0:76,0:113] #処理する領域を設定
