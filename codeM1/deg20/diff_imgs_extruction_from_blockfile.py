...
dir_save=r"E:\Liu\20240226_stereo_with_sato\diff_img_raw\20deg\\" #回折図形の画像を出力するディレクトリを指定
os.makedirs(dir_save,exist_ok=True) #上記で指定したディレクトリを作成する

data_block=hs.load(r"E:\Sato\20231013_experimentaldata_ARM_SPED_austeniticsteel\20231013_tilt20deg.blo") #blockファイルを読み込む
