...
#マッピング結果を保存するディレクトリ
dir_save=r"E:\Liu\20240405\MLS\mapping_GB-numbering\alpha_0deg\\"
...
imgs=glob.glob(r"E:\Liu\20240405\diff_img_raw\alpha_0deg\selected\h82_w115\*.tif")
#ASTARの方位マッピングデータから作成したマスク画像のディレクトリ
masks=glob.glob(r"E:\Liu\20240405\mask_imgs\alpha_0deg\*.tif")
#MLSの基底となる平均化した回折図形のディレクトリ
bases=glob.glob(r"E:\Liu\20240405\MLS\base_diff_imgs\alpha_0deg\*.tif")
