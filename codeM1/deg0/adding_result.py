...
dir_save=r"E:\Liu\20240405\add_results\alpbha_0deg\\"
os.makedirs(dir_save,exist_ok=True)
dir_save_whole=r"E:\Liu\20240405\add_results\\"
os.makedirs(dir_save_whole,exist_ok=True)

imgs=glob.glob(r"E:\Liu\20240405\piecewise_regression\alpha_0deg\fill\*.tif")
imgs_rotate=glob.glob(r"E:\Liu\20240405\piecewise_regression\alpha_0deg\rotate_90deg\fill\*.tif")

files=os.listdir(r"E:\Liu\20240405\piecewise_regression\alpha_0deg\fill\\")
...
cv2.imwrite(dir_save_whole+"whole_result_alpha_0deg.tif",black)
