...
dir_save=r"E:\Liu\20240226_stereo_with_sato\MLS\\"
os.makedirs(dir_save,exist_ok=True)

#粒番号でナンバリングした画像を読み込み
numbering=cv2.imread(r"E:\Liu\20240226_stereo_with_sato\mask_imgs\20deg\whole\numbering.tif",0)
...
result=list(result)
np.savetxt(dir_save+"grain_combination_20deg.csv",result,delimiter=",")
