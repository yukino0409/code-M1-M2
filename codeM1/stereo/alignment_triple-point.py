...
dir_save_0deg=r"E:\Liu\20240405\stereo\alignment\0deg\\"
os.makedirs(dir_save_0deg,exist_ok=True)
dir_save_20deg=r"E:\Liu\20240405\stereo\alignment\20deg\\"
os.makedirs(dir_save_20deg,exist_ok=True)

imgs_0deg=glob.glob(r"E:\Liu\20240405\stereo\edge_detection\alpha_0deg\*tif")
imgs_20deg=glob.glob(r"E:\Liu\20240405\stereo\edge_detection\alpha_20deg\*tif")
